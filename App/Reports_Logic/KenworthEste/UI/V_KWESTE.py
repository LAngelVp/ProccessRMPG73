...
# Form implementation generated from reading ui file 'c:\Users\Angel Rodriguez\OneDrive - Kenworth Del este\Documentos\LUIS_ANGEL_VALLEJO\programakw\App\Front\V_KWESTE.ui'
#
...
"}")
        ...
        self.lblLogoKWESTE.setPixmap(QtGui.QPixmap("c:\\Users\\Angel Rodriguez\\OneDrive - Kenworth Del este\\Documentos\\LUIS_ANGEL_VALLEJO\\programakw\\App\\Front\\../Source/KWESTE.png"))
        ...
        self.btc_btc_Minimizar = QtWidgets.QPushButton(self.WBotonesSalida)
        self.btc_btc_Minimizar.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btc_btc_Minimizar.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\Angel Rodriguez\\OneDrive - Kenworth Del este\\Documentos\\LUIS_ANGEL_VALLEJO\\programakw\\App\\Front\\../Source/Icon_Minimize.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.btc_btc_Cerrar = QtWidgets.QPushButton(self.WBotonesSalida)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\Angel Rodriguez\\OneDrive - Kenworth Del este\\Documentos\\LUIS_ANGEL_VALLEJO\\programakw\\App\\Front\\../Source/Icon_Close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.txt_cola = QtWidgets.QLabel(self.WTablaIzquierda)
        ...
        self.Tabla_cola = QtWidgets.QTableWidget(self.WTablaIzquierda)
        ...
        self.txt_procesado = QtWidgets.QLabel(self.WTablaDerecha)
        ...
        self.Tabla_Procesados = QtWidgets.QTableWidget(self.WTablaDerecha)
        ...
        self.btn_btn_Subir = QtWidgets.QPushButton(self.WBotonesTrabajo)
        font = QtGui.QFont()
        ...
        self.btn_btn_Eliminar = QtWidgets.QPushButton(self.WBotonesTrabajo)
        font = QtGui.QFont()
        font.setFamily("Cambria Math")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.btn_btn_Comenzar = QtWidgets.QPushButton(self.WBotonesTrabajo)
        font = QtGui.QFont()
        font.setFamily("Cambria Math")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.btn_btn_Procesados = QtWidgets.QPushButton(self.WBotonesRutas)
        font = QtGui.QFont()
        ...
        self.btn_btn_Originales = QtWidgets.QPushButton(self.WBotonesRutas)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.btn_btn_Errores = QtWidgets.QPushButton(self.WBotonesRutas)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.btn_btn_Ayuda = QtWidgets.QPushButton(self.WBotonAyuda)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("c:\\Users\\Angel Rodriguez\\OneDrive - Kenworth Del este\\Documentos\\LUIS_ANGEL_VALLEJO\\programakw\\App\\Front\\../Source/Icon_Help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.menuPagos_de_facturas_de_clientes = QtWidgets.QMenu(self.menuPagosClientes)
        self.menuPagos_de_facturas_de_clientes.setObjectName("menuPagos_de_facturas_de_clientes")
        self.menuVentas_de_servicio_detallado = QtWidgets.QMenu(self.menuPagosClientes)
        self.menuVentas_de_servicio_detallado.setObjectName("menuVentas_de_servicio_detallado")
        self.menuFacturas_de_ventas_de_refacciones = QtWidgets.QMenu(self.menuPagosClientes)
        self.menuFacturas_de_ventas_de_refacciones.setObjectName("menuFacturas_de_ventas_de_refacciones")
        ...
        self.actionObjetivos_Mensuales_PagosClientes = QtWidgets.QAction(Kenworth_del_Este)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.actionConfiguracion_ServicioDetallado = QtWidgets.QAction(Kenworth_del_Este)
        self.actionConfiguracion_ServicioDetallado.setObjectName("actionConfiguracion_ServicioDetallado")
        self.actionConfiguracion_FacturasVentasRefacciones = QtWidgets.QAction(Kenworth_del_Este)
        self.actionConfiguracion_FacturasVentasRefacciones.setObjectName("actionConfiguracion_FacturasVentasRefacciones")
        self.actionDepartamentos = QtWidgets.QAction(Kenworth_del_Este)
        ...
        self.menuVentas_de_servicio_detallado.addAction(self.actionConfiguracion_ServicioDetallado)
        self.menuFacturas_de_ventas_de_refacciones.addAction(self.actionConfiguracion_FacturasVentasRefacciones)
        self.menuPagosClientes.addAction(self.menuPagos_de_facturas_de_clientes.menuAction())
        self.menuPagosClientes.addAction(self.menuVentas_de_servicio_detallado.menuAction())
        self.menuPagosClientes.addAction(self.menuFacturas_de_ventas_de_refacciones.menuAction())
    ...
    def retranslateUi(self, Kenworth_del_Este):
        ...
        self.menuVentas_de_servicio_detallado.setTitle(_translate("Kenworth_del_Este", "Ventas de servicio detallado"))
        self.menuFacturas_de_ventas_de_refacciones.setTitle(_translate("Kenworth_del_Este", "Facturas de ventas de refacciones"))

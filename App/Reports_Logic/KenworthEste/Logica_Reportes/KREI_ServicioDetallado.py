...
class ServicioDetalladoKWESTEKREI(Variables):
    def ServicioDetalladoKWESTE_KREI(self):
        ...
        df.to_excel(os.path.join(Variables().ruta_procesados,f'SERV_KWESTE_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
    def ServicioDetalladoKWSUR_KREI(self):
        ...
        df.to_excel(os.path.join(Variables().ruta_procesados,f'SERV_KWSUR_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
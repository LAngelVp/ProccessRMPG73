...
class  OrdenesServicioKWESTEKREI(Variables):
    ...
    def OrdenesKWESTE_KREI(self):
        ...
        dfKWESTE.to_excel(os.path.join(Variables().ruta_procesados,f'OS_KWESTE_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
    ...
    def OrdenesKWSUR_KREI(self):
        ...
        dfKWSUR.to_excel(os.path.join(Variables().ruta_procesados,f'OS_KWSUR_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
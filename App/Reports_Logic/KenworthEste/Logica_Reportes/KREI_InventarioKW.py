...
class InventarioKWESTEKREI(Variables):
    def InventarioKWESTE_KREI(self):
        ...
        df2.to_excel(os.path.join(Variables().ruta_procesados,f'InvCost_KWESTE_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
    ...
    def InventarioKWSUR_KREI(self):
        ...
        df2.to_excel(os.path.join(Variables().ruta_procesados,f'InvCost_KWSUR_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
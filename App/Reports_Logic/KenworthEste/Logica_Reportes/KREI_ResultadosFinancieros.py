...
class ResultadosFinancierosKREI(Variables):
    ...
    def ReporteFinancieroKWESTE_KREI(self, PATH):
        ...
        financiero.to_excel(os.path.join(Variables().ruta_procesados,f'ResulFinanciero_KREI_ESTE_SRD_{Variables().fechaPath}.xlsx'), index=False)
    ...
    def ReporteFinancieroKWSUR_KREI(self, PATH):
        ...
        financiero.to_excel(os.path.join(Variables().ruta_procesados,f'ResulFinanciero_KREI_SUR_SRD_{Variables().fechaPath}.xlsx'), index=False)

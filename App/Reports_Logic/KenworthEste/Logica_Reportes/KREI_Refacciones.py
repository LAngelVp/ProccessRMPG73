...
class RefaccionesKWESTEKREI(Variables):
    def RefaccionesKWESTE_KREI(self):
        ...
        df_nuevo.to_excel(os.path.join(Variables().ruta_procesados,f'REFACC_KWESTE_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
    def RefaccionesKWSUR_KREI(self):
        ...
        df_nuevo.to_excel(os.path.join(Variables().ruta_procesados,f'REFACC_KWSUR_KREI_SDR_{Variables().fechaPath}.xlsx'), index=False)
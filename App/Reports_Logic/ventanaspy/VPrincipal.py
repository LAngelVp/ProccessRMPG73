...
class Ui_VPrincipal(object):
    def setupUi(self, VPrincipal):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Source/KWE.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../../Downloads/rutas.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)

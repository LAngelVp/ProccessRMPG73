...
"}")
        ...
        self.lblLogoKWKREI = QtWidgets.QLabel(self.WLogo)
        self.lblLogoKWKREI.setText("")
        self.lblLogoKWKREI.setPixmap(QtGui.QPixmap("../Source/LOGOKREI.png"))
        ...
        self.horizontalLayout_10.addWidget(self.btnMinimizar)
        ...
        self.horizontalLayout_10.addWidget(self.btnCerrar)
        ...
        self.WCuerpo.setMinimumSize(QtCore.QSize(0, 350))
        self.WCuerpo.setMaximumSize(QtCore.QSize(16777215, 350))
        ...
        self.verticalLayout_4.addWidget(self.lblTextoEnCola)
        ...
        self.verticalLayout_4.addWidget(self.TWCola)
        ...
        self.verticalLayout_5.addWidget(self.lblTextoProcesado)
        ...
        self.verticalLayout_5.addWidget(self.TWProcesado)
        ...
        self.horizontalLayout_8.addWidget(self.btnSubir)
        ...
        self.horizontalLayout_8.addWidget(self.btnEliminar)
        ...
        self.horizontalLayout_8.addWidget(self.btnComenzar)
        ...
        self.horizontalLayout_9.addWidget(self.btn_Procesados)
        ...
        self.horizontalLayout_9.addWidget(self.btn_Originales)
        ...
        self.horizontalLayout_9.addWidget(self.btn_Errores)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("KREI", "KREI"))
        self.btnMinimizar.setToolTip(_translate("KREI", "Minimizar"))
        self.btnCerrar.setToolTip(_translate("KREI", "Cerrar"))
        self.lblTextoEnCola.setText(_translate("KREI", "Trabajos En Espera"))
        self.lblTextoProcesado.setText(_translate("KREI", "Trabajos Realizados"))
        self.btnSubir.setToolTip(_translate("KREI", "<html><head/><body><p>Selecciona un archivo .xlsx</p></body></html>"))
        self.btnSubir.setText(_translate("KREI", "Subir"))
        self.btnEliminar.setToolTip(_translate("KREI", "<html><head/><body><p>Elimina los archivos procesados</p></body></html>"))
        self.btnEliminar.setText(_translate("KREI", "Eliminar"))
        self.btnComenzar.setToolTip(_translate("KREI", "<html><head/><body><p>Comenzar el proceso</p></body></html>"))
        self.btnComenzar.setText(_translate("KREI", "Comenzar"))
        self.btn_Procesados.setToolTip(_translate("KREI", "<html><head/><body><p>Ruta de archivos procesados</p></body></html>"))
        self.btn_Procesados.setText(_translate("KREI", "Procesados"))
        self.btn_Originales.setToolTip(_translate("KREI", "<html><head/><body><p>Ruta de archivos originales</p></body></html>"))
        self.btn_Originales.setText(_translate("KREI", "Originales"))
        self.btn_Errores.setToolTip(_translate("KREI", "<html><head/><body><p>Ruta de archivos erroneos</p></body></html>"))
        self.btn_Errores.setText(_translate("KREI", "Erroneos"))
